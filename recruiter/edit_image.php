...
?>
   <div class="app-main__outer">
                                                ...
                                                if(!empty($_FILES['image']['name']))
                                                {
                                                    ...
                                                    try
                                                    {
                                                        ...
                                                        if($size < 5242880)
                                                        {
                                                            ...
                                                            {
                                                                $sql = $conn->prepare("UPDATE rc_details SET r_img=:img WHERE r_id=:id");
                                                                echo $query;
            ...
            exit();
                                                            ...
                                                            {
                                                                 $_SESSION["img_err"]="Something went wrong! Please try again later Not upload";  
                                                            }
                                                        }
                                                        else
                                                        {
                                                            $_SESSION["img_err"]="Size of image is too big";    
                                                        }
