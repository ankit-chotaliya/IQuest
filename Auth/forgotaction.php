...
if(isset($_POST['submit'])&&$_SERVER["REQUEST_METHOD"] = "POST"){
    ...
    //     header("location: https://qualifind.rushilshah.in/Auth/forgotpassword.php");
    //     ob_flush();
    //     exit();
    // }
    // else
    ...
    if($role=="seeker"){
        try{
            ...
            if($num!=1)
            {
               $_SESSION["err_email"] = "Email not registered";
               header("location: https://qualifind.rushilshah.in/Auth/forgotpassword.php");
               ob_flush();
               exit();
            }
...
<!--[if (mso)|(IE)]></td></tr></table></td></tr></table><![endif]-->
        ...
        ';
                    ...
                    exit();
                         ...
                         $_SESSION["err_email"] = "Unable to send mail! Try again later";
                    header("location: https://qualifind.rushilshah.in/Auth/forgotpassword.php");
                    ob_flush();
                    exit();
